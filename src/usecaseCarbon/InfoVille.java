...
*/
	...
	InfoVille(int s){ // futur utilisation (But : Aller chercher ses donn̩e dans la BDD reli̩ a l'IHM de marine)
		init(s);
	...
	public static void main(String[] args){
		InfoVille i = new InfoVille(100); // 100 pour test, valeur a aller chercher dans BDD marine
