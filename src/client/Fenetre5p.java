...
public class Fenetre5p extends Ihmindic{
	...
	public Fenetre5p(String s,String s1,Boolean a,Boolean b,Boolean c,Boolean d,Boolean b1,Boolean b2,Boolean b3,Boolean b4,Boolean b5,Boolean d1,Boolean d2,Boolean d3,Boolean d4,Boolean d5) throws SQLException, ParseException, ClassNotFoundException, IOException, InterruptedException {
	 
		AideIhm f1 = new AideIhm(s,s1);
		ArrayList<String> list = f1.geTab(s, s1);
        ...
        for (int i = 0; i < list.size(); i++) {
          //System.out.println(list.get(i));
    		...
    		AideIhm f = new AideIhm(targetDay,s1);
