...
public Fenetrep2(String s,String s1) throws SQLException, ClassNotFoundException, IOException, InterruptedException {
    ...
    ItemListener itemListener = new ItemListener() {
        ...
        public void itemStateChanged(ItemEvent itemEvent) {
       	 ...
       	 bouton.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
               	 ...
               	 if((bb == true) &&(dd == false) ) { 
               		 try {
						Fenetrep3 f= new Fenetrep3(s,s1,aa,bb,cc,dd,bb1,bb2,bb3,bb4,bb5,dd1,dd2,dd3,dd4,dd5);
					} catch (ClassNotFoundException | SQLException | IOException | InterruptedException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
               	 ...
               	 if((bb== false) &&(dd==true)) {
               		 try {
						Fenetrep4 f1= new Fenetrep4(s,s1,aa,bb,cc,dd,bb1,bb2,bb3,bb4,bb5,dd1,dd2,dd3,dd4,dd5);
					} catch (ClassNotFoundException | SQLException | IOException | InterruptedException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
               	 ...
               	 if((bb== true) &&(dd==true)){ 
               		 try {
						Fenetrep5 f2= new Fenetrep5(s,s1,aa,bb,cc,dd,bb1,bb2,bb3,bb4,bb5,dd1,dd2,dd3,dd4,dd5);
					} catch (ClassNotFoundException | SQLException | IOException | InterruptedException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
      ...
      // a revoir pour eviter les ouvertures des pages suplementaires : https://www.jmdoudoux.fr/java/dej/chap-event.htm
