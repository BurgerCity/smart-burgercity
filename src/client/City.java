...
class City {
	 // String a_dialogue = JOptionPane.showInputDialog("Hauteur de la ville");
	  ...
	  private int budget =1000;//Integer.parseInt(JOptionPane.showInputDialog("Budget de la ville"));  /*city's budget in €*/
	  private int station_price =50;// Integer.parseInt(JOptionPane.showInputDialog("Prix d'une station"));  /*price to build a station*/
