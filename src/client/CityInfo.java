...
*/
	...
	CityInfo() throws ClassNotFoundException, IOException, SQLException, InterruptedException{ // futur utilisation (But : Aller chercher ses donn̩e dans la BDD reli̩ a l'IHM de marine) //2eme argument nb St tram !!
